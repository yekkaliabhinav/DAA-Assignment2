...
`;
  ...
  return (
    <div style={{ padding: '1rem' }}>
      <h1>Exact Algorithm (Algorithm 1)</h1>
      
      <section>
        <h2>Overview</h2>
        <p>
        The Exact Algorithm addresses the densest subgraph discovery problem by combining binary search with maximum flow computations.
It guarantees finding the optimal densest subgraph by modeling the problem as a series of flow networks, but at the cost of high computational complexity.
It is precise, but less scalable for very large or sparse graphs due to the heavy resource requirements.
      ...
      <section>
        ...
        <ul>
          <li>Build a flow network based on vertices and (h-1)-cliques</li>
          <li>Perform binary search over possible density values using minimum s-t cuts.</li>
          <li>Extract the densest subgraph from the minimum cut found.</li>
        </ul>
        <h3>Code</h3>
      ...
      <section>
        <h2>Expectation</h2>
        <ul>
          <li>Accurate but computationally heavy; finds the exact densest subgraph.</li>
          <li>Best suited for small to medium dense graphs.</li>
          <li>Time complexity:
𝑂
(
𝑛
