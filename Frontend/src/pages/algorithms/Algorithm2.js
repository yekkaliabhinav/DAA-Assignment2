...
int main(int argc, char** argv) {
  ...
  return (
    <div style={{ padding: '1rem' }}>
      <h1>CoreExact Algorithm</h1>
      
      <section>
        <h2>Overview</h2>
        <p>
        The CoreExact Algorithm improves upon the Exact Algorithm by introducing k-clique-core decomposition and pruning techniques to shrink the search space before heavy computations.
By smartly narrowing down the candidates and focusing only on densest regions of the graph, it preserves accuracy while achieving huge speedups, making it much more practical for large real-world graphs.
      ...
      <section>
        ...
        <ul>
        <li>Perform core decomposition to identify dense areas early.</li>
        <li>Apply binary search on reduced subgraphs (cores) only.</li>
        <li>Build smaller flow networks for faster processing.
        </li>
        </ul>
      ...
      <section>
        <h2>Expectation</h2>
        <ul>
          <li>Preserves optimality while being much faster than Exact.</li>
          <li>Time complexity:
𝑂
(
(
...
3
          ...
          <li>Scales well for large and sparse graphs</li>
        </ul>
      </section>
